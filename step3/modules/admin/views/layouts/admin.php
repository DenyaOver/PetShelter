...
<div class="header">
    ...
    <div class="nav">
        <div class="navbar-nav">
            ...
            <li class="nav-item line">
                <?= Html::a('Log in', ['pages/log-in'], ['class' => 'nav-link']) ?>
            </li>
        </div>
    </div>
    <div class="number">
...
<div class="container">
<div class="views">
    <?= Html::a('Cats Control', ['cats/'], ['class' => 'nav-link']) ?>
    <?= Html::a('Dogs Control', ['dogs/'], ['class' => 'nav-link']) ?>
    <?= Html::a('News Control', ['news/'], ['class' => 'nav-link']) ?>
    <?= Html::a('Urgent case Control', ['urgent-case/'], ['class' => 'nav-link']) ?>
    <?= Html::a('Users Control', ['users/'], ['class' => 'nav-link']) ?>
    <?= Html::a('Volunteers Control', ['volunteers/'], ['class' => 'nav-link']) ?>
</div>
<?= $content ?>
</div>
<div class="footer">
